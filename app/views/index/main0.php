<div id="mainbody">
	<div class="topimg"><img src="./images/001.jpg" width="960" height="600" alt=""></div>
	<div id="mainc">
		<?php 
		for($i=0;$i<3;$i++){
		?>
		<div class="fenlei">
			<ul>
				<li style="background:#000;color:#fff">
					<img src="./images/010.jpg" width="280" />
				...
				<li>
					<div class="list">
						<span class="list_s"><img src="./images/020.jpg" /></span>
...
<div id="mainc2">
	...
	<?php for($i=0;$i<=3;$i++){?>
		<ul>
			<li><img src="./images/03<?php echo $i;?>.jpg"/></li>
	...
	<?php for($i=0;$i<=3;$i++){?>
		<ul>
			<li><img src="./images/03<?php echo 3-$i;?>.jpg"/></li>
